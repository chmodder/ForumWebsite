...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    ...
    <%--<a id="CreateThreadLink" runat="server" visible='<%# Per.Allowed("CreateThread") %>' href='CreateThread.aspx?CatId=<%= QsId %>' class="btn btn-default">Opret Tråd</a>--%>
    <asp:HyperLink ID="CreateThreadLink" runat="server" Visible='false' NavigateUrl='<%#"CreateThread.aspx?CatId=" + (string)QsId %>' class="btn btn-default">Opret Tråd</asp:HyperLink>
